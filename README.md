...
This is a forked version of [tap-rest-api-msdk (v1.4.1)](https://github.com/Widen/tap-rest-api-msdk) that maintained by the Broadvoice BI team.

Main differences from the original version:

- New Authentication OAuth 1.0
